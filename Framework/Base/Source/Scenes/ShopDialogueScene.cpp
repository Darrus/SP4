...
ShopDialogueScene::ShopDialogueScene() :
textPos(0),
...
void ShopDialogueScene::Init()
{
	...
	toShopScene->SetDesiredScene("Shop");
...
void ShopDialogueScene::Exit()
{
	delete text;
}

void ShopDialogueScene::Pause()
{
	textPos = 0;
	dialogue.clear();
	targetScene = "";
